    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-4 my-2 md:my-auto items-stretch z-10 py-2 overflow-visible flex-initial md:flex-1 md:min-h-0">
          ...
          <div className="md:col-span-5 flex flex-col justify-between overflow-visible">
            <div>
              ...
              <div className="text-[10px] font-serif text-current/90 leading-relaxed text-justify line-clamp-5">
                {paragraphs[0]}
              </div>
            </div>
